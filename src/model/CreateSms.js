...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SalestreamApi.CreateSms = factory(root.SalestreamApi.ApiClient, root.SalestreamApi.Text);
  }
  ...
  /**
   * The CreateSms model module.
   * @module model/CreateSms
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CreateSms</code>.
   * @alias module:model/CreateSms
   * @class
   */
  ...
  /**
   * Constructs a <code>CreateSms</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateSms} obj Optional instance to populate.
   * @return {module:model/CreateSms} The populated <code>CreateSms</code> instance.
   */
