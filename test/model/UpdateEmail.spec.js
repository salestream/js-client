...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SalestreamApi.UpdateEmail();
  });
  ...
  describe('UpdateEmail', function() {
    it('should create an instance of UpdateEmail', function() {
      // uncomment below and update the code to test UpdateEmail
      //var instance = new SalestreamApi.UpdateEmail();
      //expect(instance).to.be.a(SalestreamApi.UpdateEmail);
    });
