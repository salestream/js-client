...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SalestreamApi.RegisterResource();
  });
  ...
  describe('RegisterResource', function() {
    it('should create an instance of RegisterResource', function() {
      // uncomment below and update the code to test RegisterResource
      //var instance = new SalestreamApi.RegisterResource();
      //expect(instance).to.be.a(SalestreamApi.RegisterResource);
    });
