...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SalestreamApi.CreateTask();
  });
  ...
  describe('CreateTask', function() {
    it('should create an instance of CreateTask', function() {
      // uncomment below and update the code to test CreateTask
      //var instance = new SalestreamApi.CreateTask();
      //expect(instance).to.be.a(SalestreamApi.CreateTask);
    });
