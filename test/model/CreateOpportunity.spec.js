...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SalestreamApi.CreateOpportunity();
  });
  ...
  describe('CreateOpportunity', function() {
    it('should create an instance of CreateOpportunity', function() {
      // uncomment below and update the code to test CreateOpportunity
      //var instance = new SalestreamApi.CreateOpportunity();
      //expect(instance).to.be.a(SalestreamApi.CreateOpportunity);
    });
