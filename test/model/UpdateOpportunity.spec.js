...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SalestreamApi.UpdateOpportunity();
  });
  ...
  describe('UpdateOpportunity', function() {
    it('should create an instance of UpdateOpportunity', function() {
      // uncomment below and update the code to test UpdateOpportunity
      //var instance = new SalestreamApi.UpdateOpportunity();
      //expect(instance).to.be.a(SalestreamApi.UpdateOpportunity);
    });
    ...
    it('should have the property estCloseDate (base name: "est_close_date")', function() {
      // uncomment below and update the code to test the property estCloseDate
      //var instance = new SalestreamApi.UpdateOpportunity();
      //expect(instance).to.be();
    });
